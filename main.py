...
app.layout = html.Div([
    html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.H5('Covid-19 Data Visualization', style= {'margin-bottom': '0px', 'color': 'white'})
            ])
    ...
    html.Div([
            ...
            html.P('New: ' + f"{(covid_data_1['recovered'].iloc[-1] - covid_data_1['recovered'].iloc[-2]):,.0f}"
                   + ' ('+ str(round((covid_data_1['recovered'].iloc[-1] - covid_data_1['recovered'].iloc[-2])/covid_data_1['recovered'].iloc[-1] * 100,2)) + '% )',
                   style={'textAlign':'center',
                          'color': 'green',
                          'fontSize': 15,
                          'margin-top': '-18px'}),
...
def update_graph(w_countries):
    ...
    covid_data_3['Rolling Ave'] = covid_data_3['daily_confirmed'].rolling(window=7).mean()
    return {
        'data':[go.Bar(
            ...
            go.Scatter(
                ...
                mode = 'lines',
                name='Rolling Average of Last 7 Days - Daily Confirmed Cases',
...
def update_graph(w_countries):
    ...
    return {
        ...
        'layout':go.Layout(
            ...
            mapbox=dict(
                accesstoken='pk.eyJ1IjoiYW5pa2V0d2FnaDA3MDgiLCJhIjoiY2tyYnhzbGJlM3ZlcDJvbW4zbG52dnM0ZiJ9.RTvoLuFzgxqwPPzJh5D_Mg',
